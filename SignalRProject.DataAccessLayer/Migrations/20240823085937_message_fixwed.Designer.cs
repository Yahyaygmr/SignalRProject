...
namespace SignalRProject.DataAccessLayer.Migrations
{
    ...
    [Migration("20240823085937_message_fixwed")]
    partial class message_fixwed
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SignalRProject.EntityLayer.Entities.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SignalRProject.EntityLayer.Entities.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SignalRProject.EntityLayer.Entities.Basket", b =>
                {
            ...
            modelBuilder.Entity("SignalRProject.EntityLayer.Entities.MenuTable", b =>
                {
                    b.Property<int>("MenuTableId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SignalRProject.EntityLayer.Entities.Message", b =>
                {
            ...
            modelBuilder.Entity("SignalRProject.EntityLayer.Entities.MoneyCase", b =>
                {
            ...
            modelBuilder.Entity("SignalRProject.EntityLayer.Entities.Notification", b =>
                {
            ...
            modelBuilder.Entity("SignalRProject.EntityLayer.Entities.Order", b =>
                {
            ...
            modelBuilder.Entity("SignalRProject.EntityLayer.Entities.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("SignalRProject.EntityLayer.Entities.Slider", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("SignalRProject.EntityLayer.Entities.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("SignalRProject.EntityLayer.Entities.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SignalRProject.EntityLayer.Entities.Basket", b =>
                {
                    b.HasOne("SignalRProject.EntityLayer.Entities.MenuTable", "MenuTable")
                        .WithMany("Baskets")
                        .HasForeignKey("MenuTableId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SignalRProject.EntityLayer.Entities.Product", "Product")
                        .WithMany("Baskets")
            ...
            modelBuilder.Entity("SignalRProject.EntityLayer.Entities.OrderDetail", b =>
                {
                    b.HasOne("SignalRProject.EntityLayer.Entities.Order", "Order")
